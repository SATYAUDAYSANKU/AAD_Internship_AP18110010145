...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            String s=savedInstanceState.getString("satya");
            String u=savedInstanceState.getString("uday");
            t1.setText(s);
            t2.setText(u);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putString("satya",t1.getText().toString());
        outState.putString("uday",t2.getText().toString());
    }
}